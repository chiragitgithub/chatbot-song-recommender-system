...
<head>
	 <title>Electronics playlist</title>
...
<body>
    ...
    <aside>
    	...
    	<div id="similar-artist">
    		...
    		<div id="song-details">
    			<a style="padding:20px;font-size:30px;" href="roadtrip.php">Roadtrip</a>
    			<br/>
    	    </div>
...
<div class="alb">
	<?php 
	 include "db_conn.php";
	 $sql = "SELECT * FROM electronics ORDER BY id DESC";
